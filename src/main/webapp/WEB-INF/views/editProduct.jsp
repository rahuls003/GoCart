...
<div class="container-wrapper">
    <div class="container">
        ...
        <form:form class="form-horizontal" action="${pageContext.request.contextPath}/product/editProduct1"
                   method="post" commandName="product1" enctype="multipart/form-data"> 
        ...
        <form:hidden path="productId" value="${product.productId}" />
           ...
           <div class="form-group">
				...
				<div class="col-sm-4">
				<form:input path="image" type="file" class="form-control" placeholder="select a image" />
				</div>
			</div>
